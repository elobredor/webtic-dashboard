...
interface MultiFileInputProps {
	...
	maxFiles?: number;
	accept?: string;
	previewImages?: string[]; // Nueva propiedad para imágenes opcionales
}
...
const MultiFileInput: React.FC<MultiFileInputProps> = ({
	...
	previewImages = [], // Valor predeterminado
}) => {
	...
	return (
		<div className="space-y-4">
						...
						>
							...
							{file.type.startsWith("image/") ? (
								<Image
									...
									onClick={() => openPreview(URL.createObjectURL(file))}
			...
			{/* Preview Images Grid */}
			{previewImages.length > 0 && files.length === 0&& (
				<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
